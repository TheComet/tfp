...
// Unary operations
SFGSYM_PUBLIC_API double negate(double a);

// Binary operations
SFGSYM_PUBLIC_API double add(double a, double b);
SFGSYM_PUBLIC_API double sub(double a, double b);
SFGSYM_PUBLIC_API double mul(double a, double b);
SFGSYM_PUBLIC_API double div(double a, double b);
SFGSYM_PUBLIC_API double pow(double a, double b);
SFGSYM_PUBLIC_API double mod(double a, double b);
SFGSYM_PUBLIC_API double comma(double a, double b);
