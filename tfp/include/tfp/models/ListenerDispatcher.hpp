...
public:
    ...
    void dispatch(RET_TYPE (LISTENER_CLASS::*func)(void));
    template <class RET_TYPE, class ARG1, class PARAM1>
    void dispatch(RET_TYPE (LISTENER_CLASS::*func)(ARG1), const PARAM1& param1);
    template <class RET_TYPE, class ARG1, class ARG2, class PARAM1, class PARAM2>
    void dispatch(RET_TYPE (LISTENER_CLASS::*func)(ARG1, ARG2), const PARAM1& param1, const PARAM2& param2);
...
void ListenerDispatcher<LISTENER_CLASS>::
    dispatch(RET_TYPE(LISTENER_CLASS::*func)(void))
{
    for(iterator it = listeners_.begin(); it != listeners_.end(); ++it)
        ((*it)->*func)();
}
...
template <class RET_TYPE, class ARG1, class PARAM1>
void ListenerDispatcher<LISTENER_CLASS>::
    dispatch(RET_TYPE(LISTENER_CLASS::*func)(ARG1), const PARAM1& param1)
{
    for(iterator it = listeners_.begin(); it != listeners_.end(); ++it)
        ((*it)->*func)(param1);
}
...
template <class RET_TYPE, class ARG1, class ARG2, class PARAM1, class PARAM2>
void ListenerDispatcher<LISTENER_CLASS>::
    dispatch(RET_TYPE(LISTENER_CLASS::*func)(ARG1, ARG2), const PARAM1& param1, const PARAM2& param2)
{
    for(iterator it = listeners_.begin(); it != listeners_.end(); ++it)
